...
public class QuestionManager6 : MonoBehaviour
{
    ...
    public void CheckAnswer(int index)
    {
        ...
        StartCoroutine(DelayedAction(() => {
            ...
            questionText.text =  "Security Misconfiguration: Security misconfigurations in a computer system can leave it vulnerable to attacks or other types of damage. This can include leaving default passwords or settings in place, not properly securing network services, or failing to patch known vulnerabilities in the system. The main risk associated";
    ...
    public void Start()
    {
        string[] answers = {"A.Inefficient processing", "B.Unauthorized access", "C.Information leakage", "D.Unrestricted access"};
        SetQuestion("What is the main security risk of having security misconfigurations in a computer system?", answers, 3);
    }
