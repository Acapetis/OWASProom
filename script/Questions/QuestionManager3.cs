...
public class QuestionManager3 : MonoBehaviour
{
    ...
    public void CheckAnswer(int index)
    {
        ...
        StartCoroutine(DelayedAction(() => {
            ...
            questionText.text =  "Integrity: A virus in a computer system can pose a significant risk to the integrity of the data stored on the system, as it can cause data corruption or other types of damage to the files or software on the system.";
    ...
    public void Start()
    {
        string[] answers = {"A.Inefficient processing", "B.Data corruption", "C.Information leakage", "D.Lack of security updates"};
        SetQuestion("What is the main risk of having a virus in a computer system?", answers, 1);
    }

    public void LoadNextScene()
    {
        // Load the next scene
        SceneManager.LoadScene("4_Crypto");
    }
